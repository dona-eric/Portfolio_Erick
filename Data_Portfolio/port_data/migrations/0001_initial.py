# Generated by Django 5.1.3 on 2025-02-23 22:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.CharField(choices=[('FRONTEND', 'Frontend'), ('BACKEND', 'Backend'), ('DEVOPS', 'DevOps'), ('DATABASE', 'Base de données'), ('OTHER', 'Autre')], default='Category', max_length=200, verbose_name='Catégorie')),
